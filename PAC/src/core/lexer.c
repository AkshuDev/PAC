...
PAC_TokenType check_keyword(const char* str) {
	...
	if (strcmp(str, "imul") == 0) return ASM_IMUL;
    if (strcmp(str, "idiv") == 0) return ASM_IDIV;
    if (strcmp(str, "push") == 0) return ASM_PUSH;
    if (strcmp(str, "pop") == 0) return ASM_POP;
	if (strcmp(str, "pushf") == 0) return ASM_PUSHF;
	if (strcmp(str, "popf") == 0) return ASM_POPF;
    if (strcmp(str, "call") == 0) return ASM_CALL;
    if (strcmp(str, "ret") == 0) return ASM_RET;
	if (strcmp(str, "leave") == 0) return ASM_LEAVE;
	...
	if (strcmp(str, "cli") == 0) return ASM_CLI;
	if (strcmp(str, "clc") == 0) return ASM_CLC;
	if (strcmp(str, "cmc") == 0) return ASM_CMC;
	if (strcmp(str, "std") == 0) return ASM_STD;
	if (strcmp(str, "sti") == 0) return ASM_STI;
	if (strcmp(str, "stc") == 0) return ASM_STC;
	if (strcmp(str, "wait") == 0 || strcmp(str, "fwait") == 0) return ASM_FWAIT;
	if (strcmp(str, "lahf") == 0) return ASM_LAHF;
	if (strcmp(str, "sahf") == 0) return ASM_SAHF;
	...
	if (strcmp(str, "pause") == 0) return ASM_PAUSE;
...
const char* token_type_to_str(PAC_TokenType type) {
    switch(type) {
		...
		case ASM_IMUL: return "ASM_IMUL";
        case ASM_IDIV: return "ASM_IDIV";
        case ASM_PUSH: return "ASM_PUSH";
        case ASM_POP: return "ASM_POP";
		case ASM_PUSHF: return "ASM_PUSHF";
        case ASM_POPF: return "ASM_POPF";
        case ASM_CALL: return "ASM_CALL";
        case ASM_RET: return "ASM_RET";
		case ASM_LEAVE: return "ASM_LEAVE";
		...
		case ASM_CLI: return "ASM_CLI";
		case ASM_CLC: return "ASM_CLC";
		case ASM_CMC: return "ASM_CMC";
		case ASM_STD: return "ASM_STD";
		case ASM_STI: return "ASM_STI";
		case ASM_STC: return "ASM_STC";
		case ASM_FWAIT: return "ASM_FWAIT";
		case ASM_LAHF: return "ASM_LAFH";
		case ASM_SAHF: return "ASM_SAHF";
		...
		case ASM_PAUSE: return "ASM_PAUSE";
...
const char* token_type_to_ogstr(PAC_TokenType type) {
    switch (type) {
        ...
        case ASM_PUSHF: return "pushf";
        case ASM_POPF: return "popf";
		...
		case ASM_CLI: return "cli";
		case ASM_CLC: return "clc";
		case ASM_CMC: return "cmc";
		case ASM_STD: return "std";
